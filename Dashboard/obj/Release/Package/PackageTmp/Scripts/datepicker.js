    ...
    !function () {
        ...
        n = u, n.prototype = {
            viewIndexes: ["days", "months", "years"], init: function () {
                ...
                e = e || this.date;
                var i, s = t, a = this._getWordBoundaryRegExp, h = this.loc, r = n.getLeadingZeroNum, o = n.getDecade(e), c = n.getParsedDate(e), d = c.fullHours, l = c.hours, u = t.match(a("aa")) || t.match(a("AA")), m = "am";
        ...
        s.Body = function (t, e, i) {
            ...
            init: function () {
                ...
                var i = "datepicker--cell datepicker--cell-" + e, s = new Date, n = this.d, h = a.resetTime(n.minRange), r = a.resetTime(n.maxRange), o = n.opts, c = a.getParsedDate(t), d = {}, l = c.date;
                ...
                return o.onRenderCell && (d = o.onRenderCell(t, e) || {}, l = d.html ? d.html : l, i += d.classes ? " " + d.classes : ""), o.range && (a.isSame(h, t, e) && (i += " -range-from-"), a.isSame(r, t, e) && (i += " -range-to-"), 1 == n.selectedDates.length && n.focused ? ((a.bigger(h, t) && a.less(n.focused, t) || a.less(r, t) && a.bigger(n.focused, t)) && (i += " -in-range-"), a.less(r, t) && a.isSame(n.focused, t) && (i += " -range-from-"), a.bigger(h, t) && a.isSame(n.focused, t) && (i += " -range-to-")) : 2 == n.selectedDates.length && a.bigger(h, t) && a.less(r, t) && (i += " -in-range-")), a.isSame(s, t, e) && (i += " -current-"), n.focused && a.isSame(t, n.focused, e) && (i += " -focus-"), n._isSelected(t, e) && (i += " -selected-"), (!n._isInRange(t, e) || d.disabled) && (i += " -disabled-"), {
                    html: l,
                    classes: i
                }
                ...
                h || a._trigger("clickCell", n), h && this.opts.range ? (2 != a.selectedDates.length && !this.opts.toggleSelected || this.opts.toggleSelected) && (a._trigger("clickCell", n), a.lastSelectedDate = h) : h && this.opts.toggleSelected && a.removeDate(n), h && !this.opts.toggleSelected && (a.lastSelectedDate = h, a.opts.timepicker && (a.timepicker._setTime(h), a.timepicker.update()))
